-- Migration para Sistema de Controle Fiscal
...
INSERT INTO clients (name, cnpj, email, tax_regime) VALUES 
('Empresa Teste LTDA', '12.345.678/0001-90', 'contato@empresateste.com', 'simples_nacional'),
('Comércio Exemplo ME', '98.765.432/0001-10', 'vendas@comercioexemplo.com', 'mei'),
('Indústria ABC S/A', '11.222.333/0001-44', 'admin@industriaabc.com', 'lucro_real'),
('Serviços XYZ LTDA', '55.666.777/0001-88', 'contato@servicosxyz.com', 'lucro_presumido');

-- Insert sample taxes
INSERT INTO taxes (client_id, name, description, due_day, frequency, recurrence_type, auto_generate, weekend_rule, amount, status, priority) 
SELECT 
    c.id,
    'ICMS',
    ...
    'pending',
    'medium'
FROM clients c WHERE c.cnpj = '12.345.678/0001-90';
...
SELECT 
    ...
    'pending',
    'high'
FROM clients c WHERE c.cnpj = '55.666.777/0001-88';

-- Insert sample obligations
INSERT INTO obligations (client_id, name, description, category, due_day, frequency, recurrence_type, auto_generate, weekend_rule, status, priority)
SELECT 
    c.id,
    'SPED Fiscal',
...
SELECT 
    ...
    'pending',
    'urgent'
FROM clients c WHERE c.cnpj = '11.222.333/0001-44';

-- Insert sample installments
INSERT INTO installments (client_id, description, installment_number, total_installments, due_date, amount, status, frequency, recurrence_type, auto_generate, weekend_rule)
SELECT 
    c.id,
