import type { DashboardStats, ObligationWithDetails, Client } from "./types"
import { getClients, getTaxes, getObligations, getClientsAsync, getTaxesAsync, getObligationsAsync } from "./storage"
...
export const getObligationsWithDetailsAsync = async (): Promise<ObligationWithDetails[]> => {
...
export const calculateDashboardStatsFrom = (
  clients: Client[],
